...
## Project Structure
    ...
    ├── importasktemplates_1  # Django project configurations
...
1. Clone this repo and `cd importasktemplates_1`
...
2. Clone this repo and `cd importasktemplates_1`
